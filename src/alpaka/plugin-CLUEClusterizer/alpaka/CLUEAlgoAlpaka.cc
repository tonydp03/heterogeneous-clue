...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  void CLUEAlgoAlpaka::setup(PointsCloud const &host_pc, PointsCloudAlpaka &d_points) {
  ...
  void CLUEAlgoAlpaka::makeClusters(PointsCloud const &host_pc, PointsCloudAlpaka &d_points) {
